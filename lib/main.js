    ...
    function init() {
      ...
      // cam away
      camera = new THREE.PerspectiveCamera( 120, window.innerWidth / window.innerHeight, 0.01, 1000 )
      camera.position.set(0,1+PLAYERHEIGHT,-0.8)
