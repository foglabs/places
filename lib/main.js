    ...
    function createFloor(){
      ...
      let floor = new JunkPiece(new THREE.BoxGeometry(5, 0.1, 5), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [255,120,250], new THREE.MeshPhysicalMaterial( { map: textyMap, transparent: true, transmission: 0, reflectivity: 1, roughness: 0.5, clearcoat: 1.0, clearcoatRoughness: 0.1 }) )
    ...
    function init() {
      ...
      var chars = createScenery(DEMO)

      let floor = createFloor()
      chars[floor.mesh.id] = floor


      place = new Place("#330044", chars, floor)
      ...
      scene.add( cube.mesh )
      cube.routePoints = [[-0.2,1.1,-0.5],[-0.2,1.1,0.5],[0.8,1.1,0.5],[0.8,1.1,-0.5]]
    ...
    export { util, pointer, scene, place, game, controller }