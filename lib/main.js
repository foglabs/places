    import * as THREE from '/v3/lib/three.module.js'
    import { TubePainter } from '/v3/lib/TubePainter.js'
    // import { ARButton } from '/v3/lib/ARButton.js'
    import { VRButton } from '/v3/lib/VRButton.js'
    import { Timer } from "/v3/lib/Timer.js"
    import { Character } from '/v3/lib/Character.js'
    import { JunkPiece } from '/v3/lib/JunkPiece.js'
    import { Game } from '/v3/lib/Game.js'
    import { Pointer } from '/v3/lib/Pointer.js'
    ...
    function addScenery(){
      ...
      let textyMap = loader.load('v3/textures/floor-text.jpg') 
    ...
    function init() {
      ...
      scene.add( cube.mesh )
      // cube.routePoints = [[0,1.2,0], [0,1.2,0.2], [0,1.2,-0.2], [-0.2,1.2,-0.2], [0.2,1.2,-0.2], [0.2,1.2,0.2]]
      ...
      //   console.log( 'fuck', navigator.getGamepads() )

      // }, 2000)
      // window.addEventListener("keydown", function(e) { console.log( 'FUCKING key', e.key ) })
      // window.addEventListener("gamepadconnected", function(e) { console.log( 'g connect' ) }, false);
      // window.addEventListener("gamepaddisconnected", function(e) { console.log( 'g deleteIndsconnect' ) }, false);
    ...
    function handleController( controller ) {
      ...
      if(pointer.grabbedId){
        ...
        characters[ pointer.grabbedId ].mesh.position.set(controller.position.x, controller.position.y, controller.position.z)
      ...
      if ( userData.isSelecting === true ) {
        ...
        for ( var i = 0; i < intersects.length; i++ ) {
          ...
          if(intersects[i].object.id != line.id){
            ...
            if(pointer.grabbedId){
              ...
              char = characters[intersects[i].object.id]
        ...
        if(grabbedId){
          pointer.throw(characters[grabbedId])
        }
    ...
    // document.addEventListener("keydown", onDocumentKeyDown, false);
      ...
      export { pointer, scene, game, junk, characters, floor, controller }