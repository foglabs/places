    ...
    function init() {
      ...
      scene.fog = new THREE.FogExp2("#ffffff", 0.012);
    ...
    function handleController( controller ) {
      ...
      if ( userData.isSelecting === true ) {
        ...
        if(grabbedId){
          ...
          let droppableChars = util.k(place.characters).filter( (id) => { if(place.characters[id].droppable){ return place.characters[id] } } )
