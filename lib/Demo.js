...
class Demo extends Place {
  constructor(){
    ...
    var floor = new JunkPiece(new THREE.BoxGeometry(5, 0.1, 5), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [255,120,250], new THREE.MeshPhysicalMaterial( { map: floorMap, transparent: true, transmission: 0, reflectivity: 1, roughness: 0.5, clearcoat: 1.0, clearcoatRoughness: 0.1 }) )
