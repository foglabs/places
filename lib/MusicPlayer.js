...
class MusicPlayer extends Character {
  constructor(album=null){
    ...
    let trayAlpha = textureLoader.load('/textures/stereo-trayA.png')
    trayAlpha.wrapS = THREE.RepeatWrapping
    trayAlpha.wrapT = THREE.RepeatWrapping
    trayAlpha.repeat.set(1,1)
    ...
    // alpha looks bad
    let traymat = new THREE.MeshPhysicalMaterial( { reflectivity: 0.9, clearcoat: 0.6, map: trayMap, bumpScale: 0.04, lightMap: trayAlpha, lightMapIntensity: 0.0042, bumpMap: trayBump, color: "#ffff00" })
