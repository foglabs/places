...
class MusicPlayer extends Character {
  constructor(album=null){
    ...
    let trayAction = (droppedChar) => {
      if(this.state == OPEN && droppedChar.itemType == ALBUM){
        ...
        // put it in the try
        droppedChar.mesh.position.set( this.tray.mesh.position.x,this.tray.mesh.position.y+0.1,this.tray.mesh.position.z )
  ...
  createDisplay(){
    ...
    let dispOffset = new THREE.Vector3(0,0.0175,0.061)
