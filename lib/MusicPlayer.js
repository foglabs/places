...
class MusicPlayer extends Character {
  constructor(album=null){
    ...
    let ejectmat = new THREE.MeshStandardMaterial( { map: buttonMap, color: "#ffff00" })
    ...
    this.setDisplayText("WELCOME TO FOG STEREO HI-FI ")
  }
  ...
  createDisplay(){
    ...
    let dispBackOffset = new THREE.Vector3(0,0.02,0.050)
    this.displayBack = new Component(this, dispBackOffset, new THREE.PlaneGeometry(0.18,0.04), [10,10,255], new THREE.MeshPhysicalMaterial({transparent: false, clearcoat: 0.8, transmission: 0, bumpMap: wallBump, bumpScale: 0.09}))
    ...
    let dispOffset = new THREE.Vector3(0,0.0175,0.0503)
  ...
  loadAlbum(urls){
    ...
    for(var i=0; i<urls.length; i++){
      ...
      sound.mesh.position = this.mesh.position
