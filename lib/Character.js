...
class Character {
  ...
  hitChar(char){
    ...
    if( isWithin(this.accx, 0, 0.01) && isWithin(this.accy, 0, 0.01) && isWithin(this.accz, 0, 0.01) ){
      this.accx = 0
      this.accy = 0
      this.accz = 0
    }

    if( isWithin(char.accx, 0, 0.01) && isWithin(char.accy, 0, 0.01) && isWithin(char.accz, 0, 0.01) ){
      char.accx = 0
      char.accy = 0
      char.accz = 0
    }
