...
class RelaxingRain extends Place {
  constructor(){
    ...
    // var lighter = new THREE.HemisphereLight("#ffffff", "#000000", 0.0006)
    // scene.add(lighter)
    ...
    // var mountainLight = new THREE.SpotLight("#bbbbbb", 0.01)
 ...
 console.log( 'its ', charqfgf20fm3nd2.mesh.id )
    ...
    forestMap.wrapS = THREE.RepeatWrapping
    forestMap.wrapT = THREE.RepeatWrapping
    forestBump = textureLoader.load("/textures/forestB.png")
    forestBump.wrapS = THREE.RepeatWrapping
    forestBump.wrapT = THREE.RepeatWrapping
    ...
    mountainGeo = new THREE.PlaneGeometry( 10, 10, 10 )
    ...
    for(var i=0; i<0; i++){
      ...
      mountainMat = new THREE.MeshPhysicalMaterial( {map: forestMap, bumpMap: forestBump, color: "#ffffff",  } )
      // displacementMap: mountainMap, displacementScale: 10
  ...
  plantHandler(mesh, position, scale){ 
      console.log( 'I have received the payload?', mesh.material )
