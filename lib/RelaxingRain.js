...
class RelaxingRain extends Place {
  constructor(){
    ...
    charqfgf20fm3nd.mesh.position.set(0.0900000000000003,1.2,-0.66)
    ...
    charqfgf20fm3nd2.mesh.position.set(-0.0000000000000003,1.2,-0.66)
    ...
    for(var i=0; i<10; i++){
      ...
      x = util.randomSign() * (Math.random() * 5 + 6)
      y = 7
      z = util.randomSign() * (Math.random() * 5 + 6)
