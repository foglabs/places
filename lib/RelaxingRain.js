...
class RelaxingRain extends Place {
  constructor(){
    ...
    // I need a light
    let light = new THREE.PointLight( 0xffffdd, 0.04, 100 )
    ...
    charqfgf20fm3nd.mesh.position.set(0.5900000000000003,1.2,-0.76)
    charqfgf20fm3nd.mesh.rotation.set(0,0,0)
    scene.add( charqfgf20fm3nd.mesh )
    characters[charqfgf20fm3nd.mesh.id] = charqfgf20fm3nd
 
    // table
    var charctw2g1t5rg5 = new Character( new THREE.BoxGeometry( 0.3100000000000002,0.36000000000000026,0.34000000000000025 ), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [200,200,200], new THREE.MeshPhysicalMaterial( { map: wallMap, transparent: true, transmission: 0.5, reflectivity: 1, roughness: 0, clearcoat: 1.0, clearcoatRoughness: 0.1 }) )
    charctw2g1t5rg5.mesh.position.set(-3.469446951953614e-18,1.06,-0.3399999999999999)
