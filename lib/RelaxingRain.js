    ...
    if(this.boxIds){
      if(this.boxTimer.time() > 3000){
        ...
        for(var i=0; i<this.boxIds.length; i++){
          ...
          this.characters[this.boxIds[i]].scalex = Math.random() * 3
          this.characters[this.boxIds[i]].scaley = Math.random() * 3
          this.characters[this.boxIds[i]].scalez = Math.random() * 3
           // choose new orientation every 3s
          this.characters[this.boxIds[i]].rotx = Math.random() * Math.PI * 2
          this.characters[this.boxIds[i]].roty = Math.random() * Math.PI * 2
          this.characters[this.boxIds[i]].rotz = Math.random() * Math.PI * 2
        }  
      }
