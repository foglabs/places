...
class RelaxingRain extends Place {
  constructor(){
    ...
    var spotlight = new THREE.SpotLight("#0000bb", 0.03)
    ...
    for(var i=0; i<10; i++){
      ...
      x = util.randomSign() * (Math.random() * 2 + 6)
      y = 7
      z = util.randomSign() * (Math.random() * 2 + 6)

      console.log( 'xyz', x,y,z )
      this.mountains[i].position.set(x, y ,z)
      this.mountains[i].rotation.y = Math.random()*util.radian(5)
