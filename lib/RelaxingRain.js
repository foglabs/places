...
class RelaxingRain extends Place {
  constructor(){
    ...
    //   box = new Character( new THREE.BoxGeometry(0.033,0.033,0.033), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [255,0,255], new THREE.MeshPhysicalMaterial( { color: "#ff00ff" }), boxClick )
    ...
    for(var q=0; q<16; q++){
      ...
      let thisStars = new THREE.Points(starsGeo,starsMaterial)

      this.stars.push( thisStars )
      scene.add( thisStars )
...
// boom
  ...
  createAlbums(){
    ...
    let labDream = new Album("Fog Labs", "Lab Dream", "https://fog-places.s3.amazonaws.com/LabDream/LabDreamCover.png", labDreamUrls, labDreamTitles)
    ...
    let lateContact = new Album("late", "Contact", "https://fog-places.s3.amazonaws.com/LateContactMastered/LateContactMasteredCover.png", lateContactUrls, lateContactTitles)
    ...
    let blueLight = new Album("Fog Labs", "Blue Light", "https://fog-places.s3.amazonaws.com/BlueLight/BlueLightCover.png", blueLightUrls, blueLightTitles)
    ...
    // osunds
    let adsUrls = [
      "https://fog-places.s3.amazonaws.com/Ads/thebigstory1.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/thebigstory2.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/thebigstory3.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/bigstory4.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/bigstory5.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/adold3.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/adold6.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/emotions1.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/emotions2.mp3",
      "https://fog-places.s3.amazonaws.com/Ads/emotions3.mp3",
    ]
    ...
    let ads = new Album("GBC", "The Ads", "https://fog-places.s3.amazonaws.com/Ads/AdsCover.png", adsUrls, adsTitles)
    // this.albums["ads"] = ads

    ads.mesh.position.set( -0.8, 1.4, -0.2 )
    scene.add(ads.mesh)
    this.characters[ads.mesh.id] = ads
  }
