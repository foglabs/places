...
class RelaxingRain extends Place {
  constructor(){
    ...
    // table2
    var charctw2g1t5rg52 = new Character( new THREE.BoxGeometry( 0.3100000000000002,0.36000000000000026,0.94000000000000025 ), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [110,110,110], new THREE.MeshStandardMaterial( { map: tableMap, alphaMap: tableMapA, bumpScale: 0.8, bumpMap: tableMapB}) )
