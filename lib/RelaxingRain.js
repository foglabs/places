...
class RelaxingRain extends Place {
 ...
 console.log( 'its ', charqfgf20fm3nd2.mesh.id )
    ...
    for(var i=0; i<0; i++){
      ...
      mountainMat = new THREE.MeshPhysicalMaterial( {map: forestMap, bumpMap: forestBump, transparent: false, color: "#FFFFFF", side: THREE.DoubleSide } )
