...
class RelaxingRain extends Place {
  constructor(){
    ...
    charqfgf20fm3nd2.mesh.position.set(0.0400000000000003,1.2,-0.86)
    ...
    this.musicPlayer = new MusicPlayer(urls)
    this.musicPlayer.pushable = false
    this.musicPlayer.mesh.position.set(-0.4,1.3,-0.9499999999999999)
    scene.add( this.musicPlayer.mesh )

    // this.musicPlayer.playSong(0)
  }
