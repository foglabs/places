...
class RelaxingRain extends Place {
  constructor(){
    ...
    // I need a light
    let light = new THREE.SpotLight( 0xffffdd, 0.011, 100 )
    ...
    // go board
    var char24xq7w9ca9 = new Character( new THREE.BoxGeometry( 0.2700000000000002,0.008,0.3000000000000002 ), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [50,50,50], new THREE.MeshPhysicalMaterial( { map: wallMap, bumpMap: wallBump, bumpScale: 0.002, transparent: true }) )
 ...
 console.log( 'its ', charqfgf20fm3nd2.mesh.id )
    ...
    // table
    var charctw2g1t5rg5 = new Character( new THREE.BoxGeometry( 0.3100000000000002,0.36000000000000026,0.34000000000000025 ), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [110,110,110], new THREE.MeshStandardMaterial( { map: tableMap, bumpScale: 0.8, bumpMap: tableMapB}) )
    ...
    var floor = new JunkPiece(new THREE.BoxGeometry(2.2, 0.1, 2.2), new THREE.Box3(new THREE.Vector3(), new THREE.Vector3()), [255,255,255], new THREE.MeshPhysicalMaterial( { map: textyMap, bumpMap: textyBump, bumpScale: 0.0015 }) )
    ...
    this.musicPlayer.playButton.push()
  }
